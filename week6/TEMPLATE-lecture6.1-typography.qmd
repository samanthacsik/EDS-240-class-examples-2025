...
plot <- ggplot(subset_jobs) +
  ...
  labs(title = "Males earn more than females across occupations",
       subtitle = "<span style='font-family:fa-regular;'>&#xf3d1;</span> Median earnings of full-time  <span style='color:#2D7787;'>**male**</span> vs. <span style='color:#FC6B4B;'>**female**</span> workers by occupation in 2016",
       caption = "Data Source: TidyTuesday (March 5, 2019)<br><span style='font-family:fa-brands;'>&#xf09b;</span> samanthacsik") +
