...
# #.........................get shape data.........................
county_geo <- tigris::counties(class = "sf", cb = TRUE, year = 2023) |> # cb = TRUE to use cartographic boundary files
...
sf::st_write(county_geo, here::here("week5", "data", "output", "tl-county-2023.shp"))
test <- sf::st_read(here::here("week5", "data", "output", "tl-county-2023.shp"))

# #.................import county-level shapefiles.................
# # data originally downloaded from https://www2.census.gov/geo/tiger/TIGER2024/ ----
# # available for download from Google Drive: TBD
# county_geo <- sf::st_read(here::here("week5", "data", "tl_2024_us_county", "tl_2024_us_county.shp")) |> 
#    sf::st_transform("ESRI:102003")
# 
# test <- county_geo |> 
#   tigris::erase_water(year = 2020, area_threshold = 0.95)


# https://catalog.data.gov/dataset/tiger-line-shapefile-2023-county-lynn-county-tx-linear-hydrography/resource/a9422786-81ab-44fb-8efe-c73b44190529
...
state_fips <- fips_codes |> # `fips_codes` is a df built into `{tigris}`
  select(statefp = state_code, state_name) |> 
...
county_geo_wrangled <- county_geo |>
  ...
  # join by `statefp` to add state_name to geometry data ---- 
...
#range(na.omit(joined_precip_geom$perc_change))
```
